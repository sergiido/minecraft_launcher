...
# from: https://www.raspberrypi.org/forums/viewtopic.php?t=242585

java -Xmx1G -Xmn128M -XstartOnFirstThread \
-Dfile.encoding=CP866 \
-Djava.library.path=$NATIVES_DIR \
-cp :\
$MC_DIR/libraries/optifine/OptiFine/1.14.4_HD_U_F4/OptiFine-1.14.4_HD_U_F4.jar:\
$MC_DIR/libraries/optifine/launchwrapper-of/2.1/launchwrapper-of-2.1.jar:\
...
$MC_DIR/libraries/org/lwjgl/lwjgl/3.2.1/lwjgl-3.2.1-natives-macos.jar:\
$MC_DIR/libraries/com/mojang/text2speech/1.11.3/text2speech-1.11.3.jar:\
$MC_DIR/versions/$VERSION/$VERSION.jar net.minecraft.launchwrapper.Launch \
--username $PLAYER \
--accessToken a56b20207080457c806e58f6275a2f41 \
--uuid fce2bbda20c04097a24dd7b261febd9b \
--version $VERSION \
--userProperties {} \
--gameDir $GAME_DIR \
--width $WIDTH \
